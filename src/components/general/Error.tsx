...
const Error: React.FC<Props> = ({ imgSrc, heading, subText, onDisable, btnText }) => {
    return (
        createPortal(
            <div className="fixed top-0 bg-[rgba(35,37,44,0.4)] z-[9999999] left-0 h-screen w-full flex items-center lg:px-0 px-5 lg:justify-center">
                <div className="bg-white relative lg:min-w-[840px] min-w-full rounded-[20px]">
                    ...
                    <div className="lg:max-w-[568px] md:max-w-[560px] md:px-0 px-5 mx-auto py-20">
                        <div className="flex flex-col items-center gap-6 justify-center">
                            ...
                            <div className="w-full">
                                ...
                                {
                                    subText ? <p className='font-medium text-base text-center leading-5 text-main-darkBase opacity-60'>{subText}</p> : null
                                }
                            </div>

                            <div className="flex w-full justify-center flex-row">
                                <div className="flex flex-row gap-[10px]">
                                    <Button rounded='4px' padding='16px 32px' border='1px solid #747A88' type='button'>
                                        <span className='font-medium text-xs leading-[15px] text-center text-main-mainGray'>{btnText}</span>
                                    </Button>
                                </div>
                            </div>
                        </div>
